...
- One increase in value of risk reduction corresponds to a .0041 increase in the probability that a person will say yes to the ballot. 
...
```{r}
lm_cost <- lm(bid ~ age + income + NEP + risk + vote, data = hw3_raw)
summary(lm_cost)

q3 <- data.frame(risk = 60, vote = 1, NEP = 32, income = "poor", age = "tothirty") # Make a new data frame
q3_cost <- predict(lm_cost, newdata = q3, type = "response") # Find probability of survival
q3_cost
```
